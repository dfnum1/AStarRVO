namespace AStarPathfinding
{
    ...
    public class Node : System.IComparable<Node>
    {
        ...
        private float m_gCost; // 从起点到当前节点的代价
        private float m_hCost; // 从当前节点到终点的估计代价
        ...
        public float HCost { get { return m_hCost; } set { m_hCost = value; } }
        public float FCost { get { return m_gCost + m_hCost; } }
